 ...
 */
final class Version20210907082138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type_role VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE legal_company_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE phone (id INT AUTO_INCREMENT NOT NULL, user_property_id INT NOT NULL, phone VARCHAR(255) NOT NULL, is_main TINYINT(1) NOT NULL, is_telegram TINYINT(1) DEFAULT NULL, is_viber TINYINT(1) DEFAULT NULL, is_whats_app TINYINT(1) DEFAULT NULL, INDEX IDX_444F97DDFD89DA79 (user_property_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_property (id INT AUTO_INCREMENT NOT NULL, company_type_id INT NOT NULL, district_id INT DEFAULT NULL, locality_id INT DEFAULT NULL, legal_company_type_id INT DEFAULT NULL, company_name VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, facebook_link VARCHAR(255) DEFAULT NULL, instagram_link VARCHAR(255) DEFAULT NULL, INDEX IDX_6B7FF8DEE51E9644 (company_type_id), INDEX IDX_6B7FF8DEB08FA272 (district_id), INDEX IDX_6B7FF8DE88823A92 (locality_id), INDEX IDX_6B7FF8DEAA00EA09 (legal_company_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE phone ADD CONSTRAINT FK_444F97DDFD89DA79 FOREIGN KEY (user_property_id) REFERENCES user_property (id)');
        $this->addSql('ALTER TABLE user_property ADD CONSTRAINT FK_6B7FF8DEE51E9644 FOREIGN KEY (company_type_id) REFERENCES company_type (id)');
        $this->addSql('ALTER TABLE user_property ADD CONSTRAINT FK_6B7FF8DEB08FA272 FOREIGN KEY (district_id) REFERENCES district (id)');
        $this->addSql('ALTER TABLE user_property ADD CONSTRAINT FK_6B7FF8DE88823A92 FOREIGN KEY (locality_id) REFERENCES locality (id)');
        $this->addSql('ALTER TABLE user_property ADD CONSTRAINT FK_6B7FF8DEAA00EA09 FOREIGN KEY (legal_company_type_id) REFERENCES legal_company_type (id)');
