 ...
 */
final class Version20210617120717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lesson_module_translation ADD description VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lesson_module_translation DROP description');
    }
}
