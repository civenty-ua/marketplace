 ...
 */
final class Version20210602105606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article_translation DROP is_published');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article_translation ADD is_published TINYINT(1) DEFAULT NULL');
