...
class ArticleSlugSetterCommand extends Command
{
    protected static $defaultName = 'app:import:article-slug';
    ...
    protected function configure(): void
    {
        ...
        $this->setDescription('Application data import: article\'s slug field')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $articles = $this->entityManager->getRepository(Article::class)->findBy(['slug' => '']);
        ...
        foreach ($progressBar->iterate($articles) as $item) {
            try {
    ...
    public function processItem($item)
    {
        ...
        $slug = $slugify->slugify($item->getTranslations()['uk']->getTitle());
