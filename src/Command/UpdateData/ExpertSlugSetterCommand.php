...
class ExpertSlugSetterCommand extends Command
{
    protected static $defaultName = 'app:import:expert-slug';
    ...
    protected function configure(): void
    {
        ...
        $this->setDescription('Application data import: expert\'s slug field')
            ->setHelp('Run Application data import process for experts slug.
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($progressBar->iterate($experts) as $item) {
            try {
    ...
    public function processItem($item)
    {
        ...
        $slugCount = count($this->entityManager->getRepository(Expert::class)->findAllBySlug($slug));
